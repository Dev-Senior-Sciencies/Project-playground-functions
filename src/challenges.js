...
function compareTrue(a, b) {
  if (a === true && b === true) { /* Foi criado uma função com o operado logico && retornado true */
    return true;
  }
  return false; /* caso o contrario retorna false */
}
// Desafio 2
function calcArea(base, height) { /* foi passado dois paramentos base height  */
  return (base * height) / 2; /* retornando base * height / 2 */
}

// Desafio 3
function splitSentence(string) {  /* foi passado um paramentro para função string */
  return string.split(' '); /* usano o split para separa a string por string */
}

// Desafio 4
function concatName(array) { /* foi passado um paramentro array */
  return `${array[array.length - 1]}, ${array[0]}`; /* o retorno foi uma concatenação do array na pocição do tamanho do array -1 e array na posição 0 */
}
